...
stretching, what index now produces your 64th one-time pad key?64th one-time pad
key?
*/
...
namespace App.Tasks.Year2016.Day14
{
    ...
    {
        private const int ADDITIONAL_HASHINGS = 2016;

        private readonly OneTimePad oneTimePad;
        ...
        {
            int index = oneTimePad.GetIndexWhichProducesSixtyFourthKey(input, ADDITIONAL_HASHINGS);
