...
describes the signal to generate, but you're not sure how it's used. You'll have
to find the input to produce the right signal through experimentation.
    ...
    public class Part1 : ITask<int>
    {
        ...
        public int Solution(string input)
        {
            ...
            int registerAStartValue =
                registers.CalculateLowestRegisterAInitialPositiveIntegerThatCausesClockSignal(instructions);
