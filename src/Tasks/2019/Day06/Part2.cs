...
namespace App.Tasks.Year2019.Day6
{
    ...
    {
        private readonly OrbitsRepository orbitsRepository;

        private readonly Orbits orbits;

        public Part2()
        {
            orbitsRepository = new OrbitsRepository();
            orbits = new Orbits();
        }
        ...
        public int Solution(string input)
        {
            ...
            int minimumNumberOfOrbitalTransfersRequiredToReachSanta =
                orbits.CalculateMinimumNumberOfOrbitalTransfersRequiredToReachSanta(localOrbits);
