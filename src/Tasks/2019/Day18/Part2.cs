...
Then, the bottom-right robot collects key b, unlocking door B in the bottom-left
vault:
...
namespace App.Tasks.Year2019.Day18
{
    ...
    {
        private readonly TunnelsMapRepository tunnelsMapRepository;

        private readonly Tunnels tunnels;

        public Part2()
        {
            tunnelsMapRepository = new TunnelsMapRepository();
            tunnels = new Tunnels();
        }
