...
- The bottom-right intersection's alignment parameter is 40. To calibrate the
  cameras, you need the sum of the alignment parameters. In the above example,
  this is 76.
    ...
    public class Part1 : ITask<int>
    {
        ...
        public int Solution(string input)
        {
            ...
            int sumOfTheAlignmentParameters =
                scaffold.CalculateSumOfTheAlignmentParametersForTheScaffoldIntersections(integers);
