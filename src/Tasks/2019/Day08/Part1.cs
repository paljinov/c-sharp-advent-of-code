...
namespace App.Tasks.Year2019.Day8
{
    ...
    {
        private readonly PasswordImage passwordImage;

        public Part1()
        {
            passwordImage = new PasswordImage();
        }

        public int Solution(string input)
        {
            int numberOneAndNumberTwoDigitsProductOfLayerThatContainsFewestZeroDigits =
                passwordImage.CalculateNumberOneAndNumberTwoDigitsProductOfLayerThatContainsFewestZeroDigits(input);

            return numberOneAndNumberTwoDigitsProductOfLayerThatContainsFewestZeroDigits;
        }
    }
}
