...
namespace App.Tasks.Year2019.Day1
{
    ...
    {
        private readonly ModulesMassesRepository modulesMassesRepository;
        ...
        public int Solution(string input)
        {
            ...
            int sumOfTheFuelRequirementsForAllOfTheModulesWhenTakingIntoAccountTheMassOfAddedFuel =
                fuelCounter.CalculateSumOfTheFuelRequirementsForAllOfTheModules(modulesMasses, true);

            return sumOfTheFuelRequirementsForAllOfTheModulesWhenTakingIntoAccountTheMassOfAddedFuel;
        }
    }
}
