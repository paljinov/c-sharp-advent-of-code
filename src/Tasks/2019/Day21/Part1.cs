...
namespace App.Tasks.Year2019.Day21
{
    public class Part1 : ITask<int>
    {
        ...
        private readonly SpringDroid springDroid;

        public Part1()
        {
            integersRepository = new IntegersRepository();
            springDroid = new SpringDroid();
        }

        public int Solution(string input)
        {
            long[] integers = integersRepository.GetIntegers(input);
            int amountOfReportedHullDamage = springDroid.CalculateAmountOfReportedHullDamage(integers);
