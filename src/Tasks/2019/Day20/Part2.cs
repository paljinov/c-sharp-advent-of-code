...
namespace App.Tasks.Year2019.Day20
{
    ...
    {
        private readonly MazeMapRepository mazeMapRepository;

        private readonly Maze maze;

        public Part2()
        {
            mazeMapRepository = new MazeMapRepository();
            maze = new Maze();
        }
        ...
        public int Solution(string input)
        {
            ...
            int steps = maze.CountStepsNeededToGetFromStartTileToEndTileForRecursiveSpaces(mazeMap, portals);
