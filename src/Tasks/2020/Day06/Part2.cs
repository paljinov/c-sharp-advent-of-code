...
namespace App.Tasks.Year2020.Day6
{
    ...
    {
        private readonly PersonsAnswersRepository personsAnswersRepository;

        private readonly AnswersCounter answersCounter;

        public Part2()
        {
            personsAnswersRepository = new PersonsAnswersRepository();
        ...
        public int Solution(string input)
        {
            ...
            int everyoneYesAnswers = answersCounter.CountEveryoneYesAnswers(personsAnswers);
