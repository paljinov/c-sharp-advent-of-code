...
how many turns apart the number is from when it was previously spoken. So, after
the starting numbers, each turn results in that player speaking aloud either 0
...
namespace App.Tasks.Year2020.Day15
{
    ...
    {
        private const int SPOKEN_AT_POSITION = 2020;
