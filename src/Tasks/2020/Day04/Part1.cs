...
namespace App.Tasks.Year2020.Day4
{
    public class Part1 : ITask<int>
    {
        ...
        private readonly ValidPassports validPassports;

        public Part1()
        {
            passportsRepository = new PassportsRepository();
            validPassports = new ValidPassports();
        }
        ...
        public int Solution(string input)
        {
            ...
            int validPassports = this.validPassports.GetValidPassportsWithExpectedFields(potentialPassports);
