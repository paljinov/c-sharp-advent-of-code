...
namespace App.Tasks.Year2018.Day6
{
    public class Part1 : ITask<int>
    {
        ...
        {
            List<(int, int)> coordinates = coordinatesRepository.GetCoordinates(input);
            int sizeOfTheLargestNonInfiniteArea = area.CalculateSizeOfTheLargestNonInfiniteArea(coordinates);
