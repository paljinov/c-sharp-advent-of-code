...
namespace App.Tasks.Year2018.Day11
{
    ...
    {
        private readonly GridSerialNumberRepository gridSerialNumberRepository;

        private readonly FuelCells fuelCells;

        public Part2()
        {
            gridSerialNumberRepository = new GridSerialNumberRepository();
        ...
        public string Solution(string input)
        {
            ...
            (int x, int y, int squareSize) =
                fuelCells.FindIdentifierOfTheSquareWithTheLargestTotalPower(gridSerialNumber);
