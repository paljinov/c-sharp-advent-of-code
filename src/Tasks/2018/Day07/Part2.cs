...
namespace App.Tasks.Year2018.Day7
{
    ...
    {
        private readonly int totalWorkers = 5;

        private readonly int baseStepDuration = 60;
        ...
        {
            HashSet<(char, char)> instructions = instructionsRepository.GetInstructions(input);
            int secondsNeededToCompleteAllSteps =
                steps.CalculateSecondsNeededToCompleteAllSteps(instructions, totalWorkers, baseStepDuration);
