...
2 3 0 3 10 11 12 1 1 0 1 99 2 1 1 2 A----------------------------------
B----------- C----------- D----- In this example, each node of the tree is also
marked with an underline starting with a letter for easier identification. In
it, there are four nodes:
...
namespace App.Tasks.Year2018.Day8
{
    public class Part1 : ITask<int>
    {
        ...
        {
            Queue<int> numbers = numbersRepository.GetNumbers(input);
            (int sumOfAllMetadataEntries, _) =
                navigationSystem.CalculateSumOfAllMetadataEntriesAndRootNodeValue(numbers);
