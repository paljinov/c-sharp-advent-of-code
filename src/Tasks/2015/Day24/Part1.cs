...
namespace App.Tasks.Year2015.Day24
{
    ...
    {
        private const int PACKAGE_WEIGHTS_GROUPS = 3;

        private readonly PackageWeightsRepository packageWeightsRepository;

        private readonly QuantumEntanglement quantumEntanglement;

        public Part1()
        {
            packageWeightsRepository = new PackageWeightsRepository();
            quantumEntanglement = new QuantumEntanglement();
        }

        public long Solution(string input)
        {
            int[] packageWeights = packageWeightsRepository.GetPackageWeights(input);
            long firstGroupQuantumEntanglement =
                quantumEntanglement.GetFirstGroupQuantumEntanglement(packageWeights, PACKAGE_WEIGHTS_GROUPS);

            return firstGroupQuantumEntanglement;
        }
    }
}
