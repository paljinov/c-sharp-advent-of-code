...
namespace App.Tasks.Year2021.Day9
{
    ...
    {
        private readonly HeightmapRepository heightmapRepository;

        private readonly Heightmap heightmap;

        public Part2()
        {
            heightmapRepository = new HeightmapRepository();
        ...
        public int Solution(string input)
        {
            ...
            int productOfThreeLargestBasinsSizes = this.heightmap.CalculateProductOfThreeLargestBasinsSizes(heightmap);
