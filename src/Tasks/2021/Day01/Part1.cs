...
namespace App.Tasks.Year2021.Day1
{
    ...
    {
        private readonly DepthsRepository depthsRepository;

        private readonly Measurements measurements;

        public Part1()
        {
            depthsRepository = new DepthsRepository();
        ...
        public int Solution(string input)
        {
            ...
            int measurementsWhichAreLargerThanThePreviousMeasurement =
                measurements.CountMeasurementsWhichAreLargerThanThePreviousMeasurement(depths);
