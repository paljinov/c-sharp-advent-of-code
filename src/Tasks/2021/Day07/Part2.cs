...
namespace App.Tasks.Year2021.Day7
{
    ...
    {
        private readonly CrabHorizontalPositionsRepository crabHorizontalPositionsRepository;

        private readonly CrabSubmarines crabSubmarines;

        public Part2()
        {
            crabHorizontalPositionsRepository = new CrabHorizontalPositionsRepository();
            crabSubmarines = new CrabSubmarines();
        }

        public int Solution(string input)
        {
            int[] crabHorizontalPositions = crabHorizontalPositionsRepository.GetCrabHorizontalPositions(input);
            int leastSpentFuel = crabSubmarines
                .CalculateLeastSpentFuelWhichIsNeededToAlignForIncreasingFuelCost(crabHorizontalPositions);
