...
namespace App.Tasks.Year2021.Day17
{
    public class Part2 : ITask<int>
    {
        ...
        public int Solution(string input)
        {
            ...
            int distinctInitialVelocitiesWhichCauseProbeToBeWithinTargetArea =
                probeLauncher.CountDistinctInitialVelocitiesWhichCauseProbeToBeWithinTargetArea(targetArea);
