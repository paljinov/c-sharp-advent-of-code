...
namespace App.Tasks.Year2021.Day3
{
    ...
    {
        private readonly DiagnosticReportRepository diagnosticReportRepository;

        private readonly Submarine submarine;

        public Part2()
        {
            diagnosticReportRepository = new DiagnosticReportRepository();
            submarine = new Submarine();
        }

        public int Solution(string input)
        {
            string[] diagnosticReport = diagnosticReportRepository.GetDiagnosticReport(input);
            int submarineLifeSupportRating = submarine.CalculateSubmarineLifeSupportRating(diagnosticReport);
