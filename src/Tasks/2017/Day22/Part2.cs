...
namespace App.Tasks.Year2017.Day22
{
    ...
    {
        private readonly int totalBurstsOfActivity = 10000000;
        ...
        public int Solution(string input)
        {
            ...
            int burstsThatCausedAnInfection =
                virusCarrier.CountBurstsThatCausedAnInfectionForEvolvedVirus(nodesMap, totalBurstsOfActivity);
