...
namespace Tests.Tasks.Year2021.Day12
{
    public class Part2Tests
    {
        ...
        [Theory]
        [ClassData(typeof(CaveSystem_CaveSystemPathsThatVisitSmallCavesAtMostTwiceCount_TestData))]
        public void Solution_CaveSystemExample_CaveSystemPathsThatVisitSmallCavesAtMostTwiceCountEquals(
            string caveSystem,
            int caveSystemPathsThatVisitSmallCavesAtMostTwice
        )
        {
            Assert.Equal(caveSystemPathsThatVisitSmallCavesAtMostTwice, task.Solution(caveSystem));
        }

        public class CaveSystem_CaveSystemPathsThatVisitSmallCavesAtMostTwiceCount_TestData
            : IEnumerable<object[]>
        {
