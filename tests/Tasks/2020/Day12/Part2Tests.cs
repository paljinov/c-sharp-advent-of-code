...
namespace Tests.Tasks.Year2020.Day12
{
    public class Part2Tests
    {
        ...
        [Fact]
        public void Solution_ShipNavigationActionsExample_ManhattanDistanceBetweenStartAndEndPositionByMovingWaypointEquals()
        {
            ...
            Assert.Equal(286, task.Solution(shipNavigationActions));
        }
    }
}
